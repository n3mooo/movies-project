...
import { fetchDetailHeThongRap, fetchHeThongRap, taoLichChieu } from "../../action";
...
function ShowTime() {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      const data = {...values, maRap : maCumRap,ngayGioChieu : date}
      console.log(data)
        ...
        <div className={style.content}>
          ...
          <div className={style.main}>
            <form style={{ width: "100%" }} onSubmit={formik.handleSubmit}>
              ...
              <div className={style.select}>
                <label>Giá vé:</label>
                <Input name="giaVe" onChange={formik.handleChange} />
              </div>
